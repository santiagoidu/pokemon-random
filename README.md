# Este projeto foi feito com React.js e CSS. Para buscar um pokémon aleatório, usei a API do Pokémon e iterou os diferentes pokémons, mostrando apenas um de cada vez.
